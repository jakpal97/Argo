	...
	const features = [
		{
			...
			description:
				'Zespół certyfikowanych specjalistów w FM outsourcingu i obsłudze maszyn. Ponad 15 lat praktyki inżynieryjnej.',
		...
		},
		{
			...
			description:
				'Wszystkie systemy i instalacje działają zgodnie z najwyższymi standardami ISO oraz normami facility management.',
		...
		},
		{
			...
			description:
				'Dostosowujemy rozwiązania do specyfiki obiektu (SLA), zapewniając pełną cyfrową dokumentację techniczną.',
				...
				<div className="relative w-full rounded-[2.5rem] overflow-hidden min-h-[500px] flex items-center justify-center group">
					...
					<div className="relative z-10 text-center max-w-4xl px-6">
						<h2 className="text-4xl md:text-6xl lg:text-7xl font-bold text-white mb-8 tracking-tight leading-tight">
							Gotowy na współpracę <br />z liderem{' '}
							<span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-white">branży?</span>
						</h2>

						<p className="text-lg md:text-xl text-gray-300 font-light mb-12 max-w-2xl mx-auto leading-relaxed">
							Skontaktuj się z nami i poznaj, jak nasza kompleksowa obsługa obiektów, FM outsourcing i maintenance mogą
							usprawnić Twój biznes.
						</p>

						<div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
							<Link
								href="/kontakt"
								className="group/btn relative bg-white text-black px-10 py-5 rounded-xl font-bold font-mono uppercase tracking-wide overflow-hidden transition-all hover:scale-105">
